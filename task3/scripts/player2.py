...
class PlayerB:
    def __init__(self):
        ...
        rospy.init_node('game_status_playerB', anonymous=True)
        rospy.Subscriber('game_status', String, self.data_from_server)
        self.moves_B_pub = rospy.Publisher('player_b_moves', String, queue_size=10)
    ...
    def take_moves_input(self):
        ...
        moves = []
        for monster in ['Rock', 'Thunder', 'Wind']:
    ...
    def publish_moves(self, moves):
        self.moves_B_pub.publish(moves)
